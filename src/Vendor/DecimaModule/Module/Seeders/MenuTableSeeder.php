...
class MenuTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		Menu::create(array('name' => 'Empleados', 'lang_key' => 'decima-module::menu.empleados', 'url' => '/recursos-humanos/mantenimiento/empleados', 'action_button_id' => 'rh-emp-btn-close', 'action_lang_key' => 'decima-module::menu.empleadoAccion', 'icon' => 'fa fa-gear', 'parent_id' => $parentMenuId, 'module_id' => $accountingModuleId, 'created_by' => 1));
		Menu::create(array('name' => 'Contratos', 'lang_key' => 'decima-module::menu.contratos', 'url' => '/recursos-humanos/mantenimiento/contratos', 'action_button_id' => 'rh-con-btn-close', 'action_lang_key' => 'decima-module::menu.contratoAccion', 'icon' => 'fa fa-wrench', 'parent_id' => $parentMenuId, 'module_id' => $accountingModuleId, 'created_by' => 1));
